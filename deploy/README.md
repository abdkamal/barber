...
## إن كان على الخادم موقع آخر يستخدم المنفذين 80/443
المثبّت يكتشف ذلك تلقائيًا إن كان الموجود **Caddy داخل Docker**: لا يشغّل صالوني وكيله الخاص، بل يعمل **خلف**
الوكيل الموجود، ويسألك قبل أن يضيف موقع صالوني إلى ملف إعداداته (مع نسخة احتياطية وفحص قبل التطبيق،
وإعادة الملف كما كان إن فشل الفحص). **مواقعك الحالية لا تتغير.** لفك الربط لاحقًا: احذف من ذلك الملف ما بين
`# saloni-begin` و`# saloni-end` ثم أعد تحميل الوكيل.
